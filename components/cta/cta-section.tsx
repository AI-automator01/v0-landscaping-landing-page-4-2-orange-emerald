    ...
    */
    <section id="contact" className="relative bg-transparent py-0">
      <div
        ref={ref}
        className={cn(
          /* REMOVED -mt-16: To keep the 10 padding exact, we remove negative margins 
             so the content sits perfectly centered within that 40px buffer.
          */
      ...
      >
        ...
        <div className="mt-12 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          ...
          <a
            ...
            className="flex items-center px-10 py-5 rounded-full text-[11px] font-black uppercase tracking-[0.3em] text-white border border-white/90 hover:bg-white/20 backdrop-blur-sm transition-all duration-300"
          >
            Call (203) 555-0142
          </a>
        </div>
